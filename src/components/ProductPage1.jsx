    ...
    const products = [
        {
            ...
            description:
                "Experience crystal-clear audio with our premium wireless headphones. Features active noise cancellation, 30-hour battery life, and premium comfort padding.",
            shopifyUrl:
                "https://your-store.myshopify.com/products/wireless-headphones",
        },
        {
            id: 2,
            ...
            description:
                "Stay connected and track your fitness goals with our advanced smartwatch. Water-resistant design with heart rate monitoring and GPS tracking.",
        ...
        },
        {
            ...
            description:
                "Sleek and functional backpack perfect for everyday use. Features multiple compartments, laptop sleeve, and water-resistant material.",
        ...
        },
        {
            ...
            description:
                "Sustainable and comfortable organic cotton t-shirt. Soft fabric with a perfect fit, available in multiple colors.",
        ...
        },
        {
            ...
            description:
                "Keep your drinks cold for 24 hours or hot for 12 hours. Double-wall vacuum insulation with leak-proof cap.",
            shopifyUrl:
                "https://your-store.myshopify.com/products/water-bottle",
        },
    ];
